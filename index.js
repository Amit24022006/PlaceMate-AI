...
// Sample AI Replies
const aiReplies = [
  "Great question! I recommend focusing on strong action verbs in your resume.",
  "For interviews, practice the STAR method: Situation, Task, Action, Result.",
  "Would you like me to help review your resume or prepare for a specific interview?",
  "Many companies use ATS systems. Make sure your resume has relevant keywords.",
  "You can join our live sessions to learn directly from industry experts!"
];
